...
public class Instruction {
    ...
    public static HashMap<String, SyntaxType> InstructionSyntax = new HashMap<String, SyntaxType>();
    static {
        RTypes.put("add",   ADD);   InstructionSyntax.put("add",   SyntaxType.DST);
        RTypes.put("addu",  ADDU);  InstructionSyntax.put("addu",  SyntaxType.DST);
        RTypes.put("sub",   SUB);   InstructionSyntax.put("sub",   SyntaxType.DST);
        RTypes.put("subu",  SUBU);  InstructionSyntax.put("subu",  SyntaxType.DST);
        RTypes.put("mult",  MULT);  InstructionSyntax.put("mult",  SyntaxType.ST);
        RTypes.put("multu", MULTU); InstructionSyntax.put("multu", SyntaxType.ST);
        RTypes.put("div",   DIV);   InstructionSyntax.put("div",   SyntaxType.ST);
        RTypes.put("divu",  DIVU);  InstructionSyntax.put("divu",  SyntaxType.ST);
        RTypes.put("mfhi",  MFHI);  InstructionSyntax.put("mfhi",  SyntaxType.D);
        RTypes.put("mflo",  MFLO);  InstructionSyntax.put("mflo",  SyntaxType.D);
        RTypes.put("and",   AND);   InstructionSyntax.put("and",   SyntaxType.DST);
        RTypes.put("or",    OR);    InstructionSyntax.put("or",    SyntaxType.DST);
        RTypes.put("xor",   XOR);   InstructionSyntax.put("xor",   SyntaxType.DST);
        RTypes.put("nor",   NOR);   InstructionSyntax.put("nor",   SyntaxType.DST);
        RTypes.put("slt",   SLT);   InstructionSyntax.put("slt",   SyntaxType.DST);
        RTypes.put("sll",   SLL);   InstructionSyntax.put("sll",   SyntaxType.DTSH);
        RTypes.put("srl",   SRL);   InstructionSyntax.put("srl",   SyntaxType.DTSH);
        RTypes.put("sra",   SRA);   InstructionSyntax.put("sra",   SyntaxType.DTSH);
        RTypes.put("sllv",  SLLV);  InstructionSyntax.put("sllv",  SyntaxType.DTS);
        RTypes.put("srlv",  SRLV);  InstructionSyntax.put("srlv",  SyntaxType.DTS);
        RTypes.put("srav",  SRAV);  InstructionSyntax.put("srav",  SyntaxType.DTS);
        RTypes.put("jr",    JR);    InstructionSyntax.put("j",     SyntaxType.C);
        ITypes.put("addi",  ADDI);  InstructionSyntax.put("addi",  SyntaxType.TSC);
        ITypes.put("addiu", ADDIU); InstructionSyntax.put("addiu", SyntaxType.TSC);
        ITypes.put("lw",    LW);    InstructionSyntax.put("lw",    SyntaxType.TCS);
        ITypes.put("lh",    LH);    InstructionSyntax.put("lh",    SyntaxType.TCS);
        ITypes.put("lhu",   LHU);   InstructionSyntax.put("lhu",   SyntaxType.TCS);
        ITypes.put("lb",    LB);    InstructionSyntax.put("lb",    SyntaxType.TCS);
        ITypes.put("lbu",   LBU);   InstructionSyntax.put("lbu",   SyntaxType.TCS);
        ITypes.put("sw",    SW);    InstructionSyntax.put("sw",    SyntaxType.TCS);
        ITypes.put("sh",    SH);    InstructionSyntax.put("sh",    SyntaxType.TCS);
        ITypes.put("sb",    SB);    InstructionSyntax.put("sb",    SyntaxType.TCS);
        ITypes.put("lui",   LUI);   InstructionSyntax.put("lui",   SyntaxType.TC);
        ITypes.put("andi",  ANDI);  InstructionSyntax.put("andi",  SyntaxType.TSC);
        ITypes.put("ori",   ORI);   InstructionSyntax.put("ori",   SyntaxType.TSC);
        ITypes.put("slti",  SLTI);  InstructionSyntax.put("slti",  SyntaxType.TSC);
        ITypes.put("beq",   BEQ);   InstructionSyntax.put("beq",   SyntaxType.STC);
        ITypes.put("bne",   BNE);   InstructionSyntax.put("bne",   SyntaxType.STC);
        JTypes.put("j",     J);     InstructionSyntax.put("j",     SyntaxType.C);
        JTypes.put("jal",   JAL);   InstructionSyntax.put("jal",   SyntaxType.C);
